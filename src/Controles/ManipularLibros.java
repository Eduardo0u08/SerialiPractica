...
public class ManipularLibros implements Serializable{
  ...
  private ArchivoL objetoarchivolibros = new ArchivoL();
    ...
    private int traePosicion(String nombreBuscar){
        ...
        if(!existe){
            System.out.println("No existe el registro de esa cosa");
            pos = -1;
        }
        return pos;
    }
    ...
    public void setobjetoarchivolibros(ArchivoL objeArchivolibros) {
        this.objetoarchivolibros = objetoarchivolibros;
    }
    
    //el metodo que se encarga de grabar los datos
    public void grabar(){
        getobjetoarchivolibros().serializar(listalibros);
    }
